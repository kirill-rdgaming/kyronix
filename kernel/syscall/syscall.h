...
#define USER_RFLAGS_MASK 0x00050DD5ULL
#define USER_RFLAGS_FIXED 0x00000202ULL

static inline uint64_t user_rflags(uint64_t v) {
    return (v & USER_RFLAGS_MASK) | USER_RFLAGS_FIXED;
}
